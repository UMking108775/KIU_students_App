  ...
  Future<void> _downloadContent() async {
    ...
    try {
      ...
      if (widget.content.contentType.toLowerCase() == 'audio') {
        userDir = await _downloadService.getUserAudioDir(currentUser.kiuId);
      } else if (widget.content.contentType.toLowerCase() == 'pdf') {
        userDir = await _downloadService.getUserPdfDir(currentUser.kiuId);
      } else {
        userDir = await _downloadService.getUserDownloadDir(currentUser.kiuId);
      }
      ...
      // Save to database with user's KIU ID
