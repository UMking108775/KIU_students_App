...
class _PdfViewerScreenState extends State<PdfViewerScreen>
  ...
  String _userKiuId = ''; // Current user's KIU ID for bookmark isolation
  ...
  void initState() {
    super.initState();
    // Get current user's KIU ID for bookmark isolation
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final authProvider = context.read<AuthProvider>();
      _userKiuId = authProvider.user?.kiuId ?? '';
      _loadBookmarks();
      _loadLastReadPage();
    });
  ...
  Future<void> _loadBookmarks() async {
    if (_userKiuId.isEmpty) return; // Wait for user ID
